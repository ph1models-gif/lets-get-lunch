                ...
                <div key={r.id} className={`bg-white rounded-xl border mb-4 overflow-hidden ${r.is_active ? 'border-gray-200' : 'border-gray-200 opacity-60'}`}>
                  ...
                  <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`https://www.letsgetlunch.nyc/restaurants/${r.id}`} target="_blank" rel="noopener noreferrer" className="text-xs text-[#4A9FD5] hover:underline break-all">letsgetlunch.nyc/restaurants/{r.id}</a>
                    </div>
                    <div className="flex items-center gap-2">
                      {!isEditing && (
                        <>
