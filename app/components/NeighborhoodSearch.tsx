...
const NEIGHBORHOODS: Record<string, {borough: string, lat: number, lng: number}> = {
  ...
  "Nolita": {borough:"Manhattan",lat:40.7234,lng:-73.9948},
  "Little Italy": {borough:"Manhattan",lat:40.7191,lng:-73.9973},
  "Two Bridges": {borough:"Manhattan",lat:40.7133,lng:-73.9934},
  "Turtle Bay": {borough:"Manhattan",lat:40.7529,lng:-73.9689},
  "Sutton Place": {borough:"Manhattan",lat:40.7570,lng:-73.9601},
  "Hudson Yards": {borough:"Manhattan",lat:40.7538,lng:-74.0022},
  "Carnegie Hill": {borough:"Manhattan",lat:40.7832,lng:-73.9558},
  "East Harlem": {borough:"Manhattan",lat:40.7957,lng:-73.9389},
  "Hamilton Heights": {borough:"Manhattan",lat:40.8232,lng:-73.9496},
  "Sugar Hill": {borough:"Manhattan",lat:40.8280,lng:-73.9441},
  "Bed-Stuy": {borough:"Brooklyn",lat:40.6872,lng:-73.9418},
  "Bay Ridge": {borough:"Brooklyn",lat:40.6350,lng:-74.0200},
  "Sunset Park": {borough:"Brooklyn",lat:40.6510,lng:-74.0040},
  "Windsor Terrace": {borough:"Brooklyn",lat:40.6560,lng:-73.9780},
  "Prospect Lefferts Gardens": {borough:"Brooklyn",lat:40.6590,lng:-73.9540},
  "Flatbush": {borough:"Brooklyn",lat:40.6501,lng:-73.9496},
  "Woodside": {borough:"Queens",lat:40.7451,lng:-73.9029},
  "Rego Park": {borough:"Queens",lat:40.7265,lng:-73.8638},
  "Elmhurst": {borough:"Queens",lat:40.7370,lng:-73.8823},
  "Corona": {borough:"Queens",lat:40.7488,lng:-73.8620},
};
